...
import { DeviceInfoSchema } from './events.js';
...
const ChatBody = z.object({
  ...
  // Attached to any feedback filed during this turn (see agent/tools.ts's
  // FeedbackContext) — not used for guidance itself, just richer bug reports.
